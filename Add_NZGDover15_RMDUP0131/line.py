...
# Calculate the median and standard deviation for each group using the log function
...
output_df = pd.DataFrame({'Median': medians, 'Std Dev': stds})
output_df.to_csv('medians_stds_gid2.txt', sep='\t', index=True)

plt.grid(True)  # Add grid lines
plt.tight_layout()
plt.savefig('lineplot_gid_Compar6.png', dpi=400)
plt.show()