...
df = pd.read_csv('Stacking_results_downsampled2.csv')
...
plt.plot(xgrid, mean, color='red', linestyle='-',linewidth = 2)
plt.axhline(y=0, color='k', linestyle='--', alpha=0.7)
plt.xlabel('Estiated Vs')
plt.ylabel('Residuals')
plt.text(0.85, 0.9, 'Mc18', fontsize=20, bbox=dict(facecolor='white', edgecolor='black', boxstyle='round,pad=0.2'),horizontalalignment='left', verticalalignment='top', transform = plt.gca().transAxes)
...
plt.savefig(f'Residuals_Mc18__.png', dpi=600)
 #   plt.show()
