...
df = pd.read_csv('Combined_Vsmatching_over15_Holocene_Rest.csv')
...
for col in df.columns[1:]:
    ...
    #plt.text(28.5, 1.35, 'Mc15 for all Holocene', fontsize=20, bbox=dict(facecolor='white', edgecolor='black', boxstyle='round,pad=0.2'))
...
#    plt.title(f'ln(Inferred Vs) - ln(Measured Vs)', fontsize=12, style='italic')
    ...
    plt.savefig(f'{col} Residuals_movingavg3.png', dpi=600)
    #plt.show()