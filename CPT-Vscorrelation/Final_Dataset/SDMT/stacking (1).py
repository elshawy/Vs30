...
input_folder = './Upsampled_Vsprofile'
search_folder = './ESTIMATED_VS_CPT_processed'
    ...
    for root, dirs, files in os.walk(search_folder):
        for file in files:
            if file == input_base_name:
                ...
                df_matching.columns = ['Depth', 'Qc', 'Fc', 'u', 'Hegazy Vs', 'Andrus-H Vs', 'Andrus-P Vs', 'Rob Vs', 'Mc15 Vs', 'Mc18 Vs', 'Ic']
